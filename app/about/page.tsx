...
export default function AboutPage() {
  ...
  const socialLinks = [
    ...
    {
      icon: FaLinkedin,
      url: 'https://linkedin.com/in/ren%C3%A9-kuhm-1aa88818a',
    },
  ];
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div className="relative">
              ...
              >
                <Image
                  ...
                  priority
                />
                <div className="absolute inset-0 bg-[#00FF7F]/20 rounded-2xl blur-[50px] -z-10" />
              </motion.div>
            </div>
            ...
            <div>
              ...
              >
                <p className="text-lg">
                  ¡Hola! Soy un apasionado desarrollador full-stack con amor por
                  la creación. Aplicaciones web innovadoras y fáciles de usar.
                  Mi viaje en tecnología Ha sido impulsado por la curiosidad y
                  un deseo constante de aprender.
                </p>
                <p className="text-lg">
                  Me especializo en tecnologías web modernas y tengo buen ojo
                  para detalle. Ya sea creando hermosas interfaces de usuario o
                  Al diseñar sistemas backend robustos, siempre estoy preparado
                  para el desafío.
                </p>
              </motion.div>
          ...
          <motion.div
            ...
            className="mt-12"
          >
            <h2 className="text-3xl font-bold mb-8 text-[#00FF7F]">
              Educación
            </h2>
              ...
              <div className="bg-gray-800/50 p-6 rounded-lg">
                ...
                <ul className="mt-4 space-y-3 text-gray-300">
                  <li className="flex items-start">
                    <svg
                      className="w-4 h-4 text-[#00FF7F] mt-1.5 mr-2"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                      role="img"
                    ...
                    <span>
                      Desarrollo Web - HTML, CSS, SASS, Bootstrap, Git
                    </span>
                  </li>
                  <li className="flex items-start">
                    <svg
              ...
              {certifications.map((cert, index) => (
                ...
                >
                  <div className="w-24 h-24 mb-4 relative">
                    <div className="absolute inset-0 bg-[#00FF7F]/20 rounded-full blur-[20px] group-hover:blur-[25px] transition-all" />
                  ...
                  <h3 className="text-lg font-semibold text-[#00FF7F] mb-2">
                    {cert.title}
                  </h3>
